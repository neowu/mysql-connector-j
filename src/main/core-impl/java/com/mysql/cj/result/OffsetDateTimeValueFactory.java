...
public class OffsetDateTimeValueFactory extends AbstractDateTimeValueFactory<OffsetDateTime> {
     ...
     */
    @Override
    public OffsetDateTime localCreateFromDate(InternalDate idate) throws DataReadException {
     ...
     */
    @Override
    public OffsetDateTime localCreateFromTime(InternalTime it) throws DataReadException {
    ...
    @Override
    public OffsetDateTime localCreateFromTimestamp(InternalTimestamp its) throws DataReadException {
    ...
    @Override
    public OffsetDateTime localCreateFromDatetime(InternalTimestamp its) throws DataReadException {
        if (its.getYear() == 0 && its.getMonth() == 0 && its.getDay() == 0) {
            throw new DataReadException(Messages.getString("ResultSet.InvalidZeroDate"));
        }
        return LocalDateTime.of(its.getYear(), its.getMonth(), its.getDay(), its.getHours(), its.getMinutes(), its.getSeconds(), its.getNanos())
    ...
    @Override
    public OffsetDateTime createFromBytes(byte[] bytes, int offset, int length, Field f) throws DataReadException {
